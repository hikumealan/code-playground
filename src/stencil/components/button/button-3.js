...
It can be used to display text and icons on a button.
...
It has a variant that can be customized.
...
It can be used with full-width buttons that work well in mobile devices.
It can be used with different variants to differentiate between primary and secondary actions.
It can be used with different sizes to fit in different areas of the website.
